...
class MambaVocV2Loss(GanBaseLoss):
    ...
    def forward(self, compute_generator_loss=True, compute_discriminator_loss=True, **batch):
        ...
        ys_hat = batch["ys_hat"] # list of [B, 1, T']
        ...
        disc_results = self._discriminate(real_audio, ys_hat)
        ...
        if compute_generator_loss:
            ...
            # Resulting loss
            out["loss_gen_adv"] = loss_gen_p + loss_gen_u

            out["loss_gen_fm"] = loss_fm_u + loss_fm_p
        ...
        if compute_discriminator_loss:
            ...
            out["loss_disc"] = loss_disc_p + loss_disc_u
        return out
